...
public class ProductController {
	...
	public ResponseEntity<Product> addProduct(@RequestBody Product product,@PathVariable("categoryId")int categoryId) {
		return new ResponseEntity<Product>(productService.addProduct( product,categoryId), HttpStatus.CREATED);
	}
	...
	/*
	 * @GetMapping("{categoryId}") public List<Product>
	 * getProductByCategoryId(@RequestBody Product
	 * product, @PathVariable("categoryId") int categoryId) { return
